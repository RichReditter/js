...
console.log('Минимум всех элементов ',min);
console.log('Максимум всех элементов равен ', max);
console.log('Среднее арифметическоe',sum / arr.length+1)
console.log('Сумма чисел на четных местах равна ', sumCh);
...
// let str = 'Срееднее арифметическое — разновидность среднего значения. Определяется как число, равное сумме всех чисел множества, делённой на их количество. Является одной из наиболее распространённых мер центральной тенденции';
// let words = str.split(' ');
...
//     words[i] = last
// }
// console.log('\nУбираем последнюю букву в каждом слове:\n',words.join(' '))


// let flist = '';
// for (let i = 0; i < words.length; i++){
//     let first = words[i]
//     if(first.startsWith('р')){
//         flist += first;
//     }
//     if (first.startsWith('Р')){
//         flist +=' '+first+' ';
//     }
// }
// console.log('Все буквы, которые начинаются с "р": \n',flist)


//В данной строке найти cумму цифр.
let str1 = 'asdfasdf12123312asdfasdfasdf'
let atr = str1.split('')
let s = 0;
for (let k = 0; k < atr.length; k++){
    let n = Number.parseInt(atr[k])
    if(n){
        s += +atr[k]
    }
